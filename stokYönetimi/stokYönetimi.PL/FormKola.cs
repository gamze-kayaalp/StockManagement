...
namespace stokYönetimi.PL
{
    ...
    public partial class FormKola : Form
    {
        ...
        private void FormKola_Load(object sender, EventArgs e)
        {
            try
            {
                // Kola stok bilgisini al ve ekrana yaz
                int mevcutStok = stokBL.GetKolaStok();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Kola stok güncelleme işlemini gerçekleştir
                stokBL.UpdateKolaStok(yeniStok);
