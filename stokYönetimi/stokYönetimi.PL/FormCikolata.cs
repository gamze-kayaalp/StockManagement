...
{
    public partial class FormCikolata : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                stokBL.UpdateCikolataStok(yeniStok);
        ...
        private void FormCikolata_Load(object sender, EventArgs e)
        {

            try
            {
                // Mevcut stok bilgisini yükleyip görüntüle
                int mevcutStok = stokBL.GetCikolataStok();
