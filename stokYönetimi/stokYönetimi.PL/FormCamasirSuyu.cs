...
{
    public partial class FormCamasirSuyu : Form
    {

        private readonly StokBL stokBL;
        public FormCamasirSuyu()
        {
            InitializeComponent();
            stokBL = new StokBL(); // StokBL nesnesi oluşturuldu
        }

        private void FormCamasirSuyu_Load(object sender, EventArgs e)
        {
            try
            {
                // Çamaşır Suyu stok bilgisini al ve ekrana yaz
                int mevcutStok = stokBL.GetCamasirSuyuStok(); // Çamaşır Suyu'nun ID'si 2
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Çamaşır Suyu stok güncelleme işlemini gerçekleştir
                stokBL.UpdateCamasirSuyuStok(yeniStok); // Çamaşır Suyu'nun ID'si 2
