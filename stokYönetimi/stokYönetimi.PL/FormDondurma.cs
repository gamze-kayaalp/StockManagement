...
{
    public partial class FormDondurma : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                stokBL.UpdateDondurmaStok(yeniStok); // Yeni stok bilgisi güncellenir
        ...
        private void FormDondurma_Load(object sender, EventArgs e)
        {
            try
            {
                // Mevcut stok bilgisini yükleyip görüntüle
                int mevcutStok = stokBL.GetDondurmaStok(); // Dondurmaya özel stok
