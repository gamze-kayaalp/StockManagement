...
{
    public partial class FormCif : Form
    {
        ...
        private void FormCif_Load(object sender, EventArgs e)
        {
            try
            {
                // CIF stok bilgisini al ve ekrana yaz
                int mevcutStok = stokBL.GetCifStok(); // CIF'in ID'si 1
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // CIF stok güncelleme işlemini gerçekleştir
                stokBL.UpdateCifStok(yeniStok); // CIF'in ID'si 1
